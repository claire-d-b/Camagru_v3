<?php
  ...
  if (isset($_POST['submit_email']) && isset($_POST['email_user']) && validate_input($_POST['email_user'], 1) == true):
    $start = false;
    ...
    if (isset($update_uuid) && !strcmp($update_uuid['username'], $email)):
...
<html dir='ltr' lang='en' style='font-family: system-ui; margin: 0; height: 100%; width: 100%;'>
  ...
  <body style='margin: 0; font-family: system-ui; width: 100%; height: 100%; overflow: hidden;'>
    <form action="mail.php" method="post" style="color: #7393B3; font-family: system-ui; display: flex; width: 100%; height: 100%; justify-content: center; align-items: center;">
      ...
      <div style="width: 100%; height: 100%; display: flex; flex-direction: column; align-items: baseline; justify-content: center;">
          ...
          <div style="margin-top: 10px;"><button name="submit_email" style="background-color: white; color: white; background-color: #7393B3; border: 1px solid white; padding: 4px; border-radius: 5px;" type="submit">Send</button></div>
