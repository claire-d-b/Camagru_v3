            ...
            if (is_not_logged() == false):
              ...
              if (isset($pictures[$i]['user_id']) && $pictures[$i]['user_id'] == $user_id): // checks whether the picture has been created by current user and add trash button if so ?>
                <form action="" method="post" style="width: 100%; display: flex; align-items: baseline; justify-content: space-between;">
                  <div style="color: #7393B3; font-weight: normal; font-size: 12px; padding-top: 15px; padding-bottom: 10px;">Created by you on <?php echo $created ?></div>
              ...
              <?php else: ?>
                <div style="display: flex; justify-content: center; color: #7393B3; font-weight: normal; font-size: 14px; padding-top: 15px; padding-bottom: 10px;">Created by <?php echo $name ?> on <?php echo $created ?></div>
              <?php endif; ?>
            <?php else: ?>
              <div style="display: flex; justify-content: center; color: #7393B3; font-weight: normal; font-size: 14px; padding-top: 15px; padding-bottom: 10px;">Created by <?php echo $name ?> on <?php echo $created ?></div>
            <?php endif; ?>
